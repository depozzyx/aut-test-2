...
import { FilledCheckboxIcon } from './FilledCheckboxIcon'

const meta: Meta<typeof FilledCheckboxIcon> = {
  title: 'Inputs/FilledCheckboxIcon',
...
export default meta
type Story = StoryObj<typeof FilledCheckboxIcon>
