...
export const Default: Story = {
  args: {
    avatars: [
      { alt: 'Trigger Testovich1', src: image.src },
      { alt: 'Trigger Testovich2', src: image.src },
      { alt: 'Trigger Testovich3', src: image.src },
      { alt: 'Trigger Testovich12', src: image.src },
      { alt: 'Trigger Testovich22', src: image.src },
      { alt: 'Trigger Testovich32', src: image.src },
    ],
    total: 6,
  },
}
